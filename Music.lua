...
spawn(function()
  pcall(function()
     while wait() do
     if SelectMusic == "Test" then
        game.Players.LocalPlayer.Character.HumanoidRootPart.Sound.SoundId = ContentProvider.BaseUrl .. "asset/?id=" .. 6443075967
     end
     end
  end)
end)
...
spawn(function()
  pcall(function()
     while wait() do
     if SelectMusic == "kuy" then
        game.Players.LocalPlayer.Character.HumanoidRootPart.Sound.SoundId = ContentProvider.BaseUrl .. "asset/?id=" .. 6718852180
     end
     end
  end)
end)

Tab1:Toggle("Play / Stop", false, function(value)
